...
let NgbdtypeheadBasic = class NgbdtypeheadBasic {
    constructor(_service) {
        ...
        this.search3 = (text3$) => text3$
            .debounceTime(200)
            .map(term => term === '' ? []
            : statesWithFlags.filter(v => v.name.toLowerCase().indexOf(term.toLowerCase()) > -1).slice(0, 10));
        this.formatter2 = (x) => x.name;
    }
};
...
exports.NgbdtypeheadBasic = NgbdtypeheadBasic;
