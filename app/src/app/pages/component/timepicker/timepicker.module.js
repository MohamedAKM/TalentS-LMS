...
const timepicker_component_1 = require("./timepicker.component");
...
const routes = [{
        ...
        component: timepicker_component_1.NgbdtimepickerBasic
    }];
...
TimepickerModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [timepicker_component_1.NgbdtimepickerBasic]
    })
], TimepickerModule);
